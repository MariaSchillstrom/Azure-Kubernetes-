...
│   ├── mongodb-pvc.yaml
│   ├── svampapp-deployment.yaml
│   ├── svampapp-service.yaml
│   └── svampapp-ingress.yaml
│
├── svamp-app/
│   └── webapp/
│       └── Svampsidan/
...
**OBS:** I produktion (AKS) nås appen via Nginx Ingress på en extern IP (se punkt 6).
...
**1.5.3 `site.css` - Styling**

* Centraliserad styling för hela applikationen
* Grönt färgtema som matchar svamp-temat
* Beige bakgrund (#f5f5dc)
* Mörkgröna rubriker (#2d5a2d)
* Ljusgröna svamp-items med grön kant
